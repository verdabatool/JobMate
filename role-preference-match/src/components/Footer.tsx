...
const Footer = () => {
  return (
    <footer className="bg-jobmate-navy text-white py-12">
      <div className="container grid gap-8 md:grid-cols-4">
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-300 max-w-xs">
            Find companies that match your dream role and preferences using our AI-powered recommendation system.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/input" className="text-sm text-gray-300 hover:text-white transition-colors">
                Find Companies
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <p className="text-sm text-gray-300 mb-4">
            Stay updated with the latest jobs and features.
          </p>
          <div className="flex gap-2">
            <input 
              type="email" 
              placeholder="Your email" 
              className="px-3 py-1 text-sm text-black rounded-md flex-1"
            />
            <button className="bg-jobmate-teal hover:bg-jobmate-teal/90 px-3 py-1 rounded-md text-white text-sm">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div className="container mt-8 pt-8 border-t border-gray-700">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">© 2025 JOB MATE. All rights reserved.</p>
